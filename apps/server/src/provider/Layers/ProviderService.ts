...
const makeProviderService = Effect.fn("makeProviderService")(function* (
  ...
  const agentAccessSettings = Effect.fn("ProviderService.agentAccessSettings")(
    function* (threadId: ThreadId) {
      ...
      const environment = {
        ...
        automations: settings.enableAgentAutomationAccess,
        readable: true,
      };
      ...
      const denied = {
        ...
        automations: environment.automations,
        readable: true,
      };
    ...
    Effect.catch((cause) =>
      Effect.logWarning(
        ...
        { cause },
      ).pipe(Effect.as({ browser: false, device: false, automations: false, readable: false })),
    ),
  );
  ...
  const agentAccessCapabilities = Effect.fn("ProviderService.agentAccessCapabilities")(function* (
    ...
    if (!access.readable) return capabilities;
    capabilities.add("pull-requests");
    capabilities.add("threads");
    capabilities.add("memory");
    if (access.automations) capabilities.add("automations");

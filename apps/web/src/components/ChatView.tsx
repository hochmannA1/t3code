...
export default function ChatView(props: ChatViewProps) {
  ...
  const mountComposerContextStrip = shouldShowComposerContextStrip({
    ...
    isGitRepo: appExperience === "code" && isGitRepo,
    showEnvironmentIndicator: appExperience === "code" && showComposerEnvironmentIndicator,
    ...
    <div className="relative flex min-h-0 min-w-0 flex-1 overflow-hidden bg-background">
      ...
      <div
        className={cn(
          ...
          rightPanelOpen && rightPanelMaximized ? "w-0 flex-none" : "flex-1",
        )}
      ...
      >
        ...
        >
          ...
          <ChatHeader
            ...
            activeProjectIcon={
              appExperience === "code" ? (activeProject?.projectIcon ?? null) : null
            }
                  ...
                  >
                    <ComposerSurface.Shell contextStrip={showComposerContextStrip}>
                      ...
                      <div className="min-h-0">
                        ...
                        >
                          {appExperience === "work" && mountComposerContextStrip ? (
                            ...
                            >
                              <div
                                ...
                                className="flex min-w-0 flex-1 items-center justify-start overflow-x-auto overflow-y-visible"
                              />
                            </ComposerSurface.ContextStrip>
                          ) : null}
        ...
        {mountedTerminalThreadRefs.map(({ key: mountedThreadKey, threadRef: mountedThreadRef }) => (
          <PersistentThreadTerminalDrawer
            ...
            active={appExperience === "code" && mountedThreadKey === activeThreadKey}
            launchContext={

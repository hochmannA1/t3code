    ...
    <SettingsPageContainer>
      ...
      <SettingsSection title="General">
        ...
        <SettingsRow
          ...
          description="Default model for generated text like thread titles, new-task recommendations, and source control content. Source control settings can override it with a dedicated source control writer model."
          resetAction={
            isTextGenerationModelDirty ? (
              <SettingResetButton
